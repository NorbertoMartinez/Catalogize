...
import { ArToolkitProfile, ArToolkitSource, ArToolkitContext, ArMarkerControls}
...
export default {
    ...
    data(){
        return {
            color: "lightgrey",
            camera_params: "/camera_para.dat",
            // pattern: "/patt.hiro",
            pattern: "/pattern-descarga.patt",
    ...
    mounted() {
        ...
        renderer.setClearColor(new THREE.Color( this.color ), 0)
        ...
        var arToolkitContext = new ArToolkitContext({
            debug: false,
            cameraParametersUrl:  this.camera_params,
            detectionMode: 'mono',
            canvasWidth: 640,
            canvasHeight: 490,
        ...
        const videoTexture = new THREE.VideoTexture(this.element);
        ...
        const screen = new THREE.PlaneGeometry(this.scale, this.scale);
        // var screen_box	= new THREE.BoxGeometry(1,1,1);

        const videoScreen = new THREE.Mesh(screen, videoMaterial);

        videoScreen.rotation.x = - Math.PI * 0.5;

        markerScene.add(videoScreen);


        // onRenderFcts.push(function(delta){
        //     // console.log(delta)
        //     videoScreen.rotation.x += 0.3 * Math.PI
        //     // videoScreen.rotation.x += delta * Math.PI
        // })
        // videoScreen.rotation.set( 2 * Math.PI * (270 / 360) )
        // videoScreen.rotateX(Math.PI / 90 );
