<template>
    ...
    <v-card >
        ...
        <v-toolbar color="deep-purple-lighten-1">
            <v-toolbar-title>Editar imagen de fondo</v-toolbar-title>
            <v-spacer></v-spacer>
                ...
                <v-row>
                    ...
                    <v-col cols="12">
                        ...
                        <v-alert
                            ...
                            closable
                        >
                           El fondo de tu sección es de utilidad para que tus clientes encuentren lo que buscan de una manera más sencilla
                        </v-alert>
                    </v-col>
...
export default {
    name: "section-change-background",
    ...
    methods: {
        ...
        __upload_picture: function (){
            ...
            if(this.record.attached){
                ...
                axios.post("/op/section-background/"+this.record.id,
                    PictureForm,
                    {
                        headers: {
